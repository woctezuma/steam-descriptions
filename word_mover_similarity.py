...
def compute_similarity_with_candidate_sentences_using_wmd(
    query_app_id,
    steam_tokens=None,
    model=None,
    candidates=None,
    ...
    similarity_scores = reformat_similarity_scores_for_wmd(
...
if __name__ == '__main__':
    ...
    compute_similarity_with_candidate_sentences_using_wmd(
        query_app_id,
